                ...
                <div class="card-body p-4">
                    ...
                    >
                        <div class="d-flex gap-3">
                            ...
                            <a
                                href="/users"
                                class="btn btn-primary rounded-pill">Benutzer</a
                            >
                        </div>
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush bg-transparent">
                        {#each data.drills as drill}
                            ...
                            >
                                <li
                                    class="list-group-item bg-transparent border-0 d-flex justify-content-between align-items-start py-3 px-4"
                                >
                                    ...
                                    >
                                        <span
                                            ...
                                            style="background-color: {drill
                                                .drill_category.color};"
                                        >
                                            {drill.drill_category.name}
                                        </span>
                                    </div>
                                </li>
                            </a>
